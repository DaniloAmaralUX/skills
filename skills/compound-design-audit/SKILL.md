---
name: compound-design-audit
description: Structured UI audit framework for rapid, intentional design decisions. Evaluates interfaces against proven UX principles — visual hierarchy, visual style, accessibility, navigation, cognitive load, social proof, onboarding and forms — and generates prioritized audit reports. Use when auditing a screen, flow or landing page, reviewing a design for completeness, making UI/UX decisions under time pressure, or choosing UI patterns for a specific problem. Triggers on UI audit, UX audit, design review, heuristic evaluation, "audit this design", "review this landing page", visual hierarchy, accessibility check, cognitive load, design decision, UX checklist.
---

# Compound Design Audit

Evaluate interfaces against proven UX principles, and make new design decisions fast without
being reckless. Rulebooks tell you *what good looks like*; this skill gives you a **decision
process plus execution checklists** so every audit finding traces back to a principle.

## When to Use This Skill

- Auditing an existing screen, flow or landing page
...
**Speed ≠ Recklessness.** Designing quickly is not automatically reckless. Recklessly designing
quickly is reckless. The difference is intentionality.
