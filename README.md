...
Skills de agente que consertam as partes do produto que a IA costuma errar — animação,
tipografia, layout e cor. Funcionam com Claude Code, Codex, Cursor e outros agentes.

## Instalação

```
npx skills add DaniloAmaralUX/skills
```
